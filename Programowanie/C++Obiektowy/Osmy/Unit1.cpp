...
void __fastcall TForm1::Otworz1Click(TObject *Sender)
{
	if(OpenDialog1->Execute()){
		try{
			...
			ShowMessage("B³¹d otwarcia pliku.Upewnij sie, ¿e plik istnieje na dysku");
		}
	}
}
//---------------------------------------------------------------------------
void __fastcall TForm1::Zapiszjako1Click(TObject *Sender)
{
	if(SaveDialog1->Execute()){
		try{
			...
			ShowMessage("Zapis zakoñczy³ sie niepowodzeniem!");
		}
	}
}
//---------------------------------------------------------------------------
...
void __fastcall TForm1::Nowy1Click(TObject *Sender)
{
	...
	L"Czy na pewno utworzyæ nowy plik?",L"Potwierdz",
...
{
	if(Application->MessageBox(
	L"Czy na pewno zakoñczyæ program?" , L"Potwierdz",
...
//---------------------------------------------------------------------------
void __fastcall TForm1::WtynijCtrrlX1Click(TObject *Sender)
{
