/**
 * Obiekt <code>Teacher</code> reprezentuje nauczyciela w szkole podstawowej.
...
public class Teacher extends Person {
    ...
    /**
     * Konstruktor odpowiedzialny za stworzenie nowego obiektu <code>Teacher</code>.
     *
    ...
    /**
     * Konstruktor odpowiedzialny za stworzenie nowego obiektu <code>Teacher</code> z najniższą kwotą krajową.
     *
     * @param name     - reprezentuje imię nauczyciela
     * @param lastName - reprezentuje nazwisko nauczyciela
     * @param pesel    - reprezentuje pesel nauczyciela
